...
F {}
E {}
N 210 920 210 970 {lab=#net1}
N 210 920 410 920 {lab=#net1}
N 410 920 410 970 {lab=#net1}
N 410 1040 410 1050 {lab=#net2}
N 210 1040 210 1050 {lab=#net2}
N 210 1110 210 1140 {lab=Z}
N 210 1140 410 1140 {lab=Z}
N 410 1110 410 1140 {lab=Z}
N 210 1040 410 1040 {lab=#net2}
N 210 1030 210 1040 {lab=#net2}
N 410 1030 410 1040 {lab=#net2}
N 410 1140 490 1140 {lab=Z}
N 210 1140 210 1180 {lab=Z}
N 210 1240 210 1270 {lab=#net3}
N 210 1330 210 1380 {lab=vss}
N 210 1380 410 1380 {lab=vss}
N 410 1330 410 1380 {lab=vss}
N 410 1240 410 1270 {lab=#net4}
N 410 1140 410 1180 {lab=Z}
N 620 1000 620 1070 {lab=#net5}
N 620 920 620 940 {lab=#net1}
N 770 1000 770 1070 {lab=#net6}
N 770 920 770 940 {lab=#net1}
N 620 920 770 920 {lab=#net1}
N 410 920 620 920 {lab=#net1}
...
N 210 1080 230 1080 {lab=#net2}
N 390 1080 410 1080 {lab=Z}
N 210 1000 230 1000 {lab=#net1}
N 390 1000 410 1000 {lab=#net2}
N 210 1210 410 1210 {lab=vss}
N 210 1300 410 1300 {lab=vss}
N 620 970 650 970 {lab=#net5}
N 650 970 650 1000 {lab=#net5}
N 620 1000 650 1000 {lab=#net5}
N 770 970 800 970 {lab=#net6}
N 800 970 800 1000 {lab=#net6}
N 770 1000 800 1000 {lab=#net6}
...
N 230 970 230 1000 {lab=#net1}
N 210 970 230 970 {lab=#net1}
N 390 1000 390 1030 {lab=#net2}
N 390 1030 410 1030 {lab=#net2}
N 230 1050 230 1080 {lab=#net2}
N 210 1050 230 1050 {lab=#net2}
N 390 1080 390 1110 {lab=Z}
N 390 1110 410 1110 {lab=Z}
...
C {sg13g2_pr/sg13_lv_pmos.sym} 430 1000 2 0 {name=M3
l=0.13u
w=0.15u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 430 1080 2 0 {name=M4
l=0.13u
w=0.15u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 430 1210 2 0 {name=M7
l=0.13u
w=0.15u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 430 1300 2 0 {name=M8
l=0.13u
w=0.15u
ng=1
m=1
...
C {iopin.sym} 170 1000 2 0 {name=p2 lab=Bb}
C {iopin.sym} 450 1000 0 0 {name=p3 lab=Ab}
C {iopin.sym} 450 1080 0 0 {name=p4 lab=B}
C {lab_pin.sym} 170 1210 0 0 {name=p5 sig_type=std_logic lab=Ab}
C {lab_pin.sym} 170 1300 0 0 {name=p6 sig_type=std_logic lab=Bb}
