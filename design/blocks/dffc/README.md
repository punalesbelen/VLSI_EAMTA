...
- `schematic/dffc.sch` - xschem schematic (IHP SG13G2 PDK)
- `schematic/dffc.sym` - xschem symbol
- `char/dffc.yaml` - CACE characterization configuration
- `char/results/` - Characterization results directory
- `layout/dffc.gds` - KLayout layout (to be created)
